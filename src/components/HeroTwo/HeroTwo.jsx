    ...
    <div ref={container}>
                ...
                <div className="container is--full">
                    <nav className="nav-row">
                        ...
                        <div className="nav-row__right">
                            <button onClick={toggleMenu} role="button" data-menu-toggle="" className="menu-button">
        ...
        <div className="osmo-credits">
            <p className="osmo-credits__p">
                ...
                <a
                    target="_blank"
                    href="https://www.osmo.supply?utm_source=codepen&utm_medium=pen&utm_campaign=side-navigation-wipe-effect"
